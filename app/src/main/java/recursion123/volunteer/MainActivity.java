...
public class MainActivity extends FragmentActivity
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (number) {
                case 1:
                    text = getString(R.string.title_section1);
                    break;
                case 2:
                    text = getString(R.string.title_section2);
                    break;
                case 3:
                    text = getString(R.string.title_section3);
                    break;
                case 4:
                    text = getString(R.string.title_section4);
                    break;
                case 5:
                    text = getString(R.string.title_section5);
                    break;
                default:
                    text = "";
                    break;
